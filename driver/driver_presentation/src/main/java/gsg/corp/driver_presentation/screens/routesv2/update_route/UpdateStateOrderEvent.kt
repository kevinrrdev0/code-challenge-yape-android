...
sealed class UpdateStateOrderEvent{
    ...
    data class OnTakeOtherPhotoOrder(val pathOtherPhotoOrder:String): UpdateStateOrderEvent()
    ...
    data class OnPayAmount1Enter(val payAmount1: String): UpdateStateOrderEvent()
    ...
    data class OnPayAmount2Enter(val payAmount2: String): UpdateStateOrderEvent()
